    ...
    @section('content')
        ...
        <div class="text-center py-5">
            ...
            <h1 class="fw-medium mb-3">Reserva, gestiona y conecta<br>con tu centro de estética y bienestar favorito</h1>
            <p class="text-muted mb-4">Encuentra peluquerías, centros de estética, fisioterapia y más.<br>Reserva tu cita en
                segundos.</p>
            <a href="{{ auth()->check() ? route('home') : route('register') }}" class="btn btn-dark me-2">
                Empezar ahora
            </a>
            <a href="{{ auth()->check() ? route('home') : route('login') }}" class="btn btn-outline-success">
                Ver centros
            </a>
        </div>
        ...
        <div class="row g-3 mb-5">
            <div class="col-md-4">
                <div class="card border p-4 h-100" style="border-radius: 12px;">
                    ...
                    <p class="text-muted small mb-3">Reserva en cualquier momento, elige servicio, fecha y hora disponible.
                    </p>
            ...
            <div class="col-md-4">
                <div class="card border p-4 h-100" style="border-radius: 12px;">
                    ...
                    <p class="text-muted small mb-3">Gestiona tu centro, servicios, horarios y clientes desde un solo lugar.
                    </p>
        ...
        {{-- registrar centros --}}
        <div class="rounded-3 p-5 text-center mb-4" style="background-color:#16a085;">
            <h2 class="fw-medium mb-2 text-white">¿Tienes un centro?</h2>
            <p class="mb-4 text-white">
                Únete y empieza a recibir reservas online hoy mismo. Gratis.
            </p>
